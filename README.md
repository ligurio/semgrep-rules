...
| [lua_pcall_result_unused](rules/c/lua-c-api/lua_pcall_result_unused.yaml) | Result of a protected call is ignored. |
...
| [lua_unsafe_c_api](rules/c/lua-c-api/lua_unsafe_c_api.yaml) | Using unsafe Lua C API function(s). |
